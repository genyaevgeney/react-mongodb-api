...
class Navbar extends Component {
    ...
    render() {
        ...
        const authLinks = (
            ...
            <Link className="navbar-first-element navbar-brand" to="/userdashboard/1">Main Page</Link>
            <ul className="navbar-middle-element navbar-nav ml-auto">
            <li className="nav-item">
                <Link className="nav-link" to="/userdashboard/1">My dashboard</Link>
            </li>
            <li className="nav-item">
                <Link className="nav-link" to="/page=1">Dashboard</Link>
            </li>
            <li className="nav-item">
      ...
      const guestLinks = (
        <div className="navbar-wrap">
        <Link className="navbar-first-element navbar-brand" to="/">Main Page</Link>
